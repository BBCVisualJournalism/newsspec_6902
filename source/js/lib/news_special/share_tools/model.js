...
define(['lib/news_special/bootstrap'], function (news) {
    ...
    */
    var NSShareModel = function (config) {
        ...
        if (opts.image) {this.setOGPImage(opts.image); } else {this.setOGPImage('http://newsimg.bbc.co.uk/news/special/2014/newsspec_6902/content/english/img/fb.jpg'); }
    ...
    */
    ...
    NSShareModel.prototype.getFacebookShareURL = function () {
    ...
    */
    NSShareModel.prototype.fbShareTarget = function () {
        ...
        '&link=' + this.getFacebookShareURL() + // URL storypage
